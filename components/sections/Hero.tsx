...
function FloatingCodeVisual({ personalInfo }: { personalInfo: PortfolioData["personalInfo"] }) {
	...
	const centralX = useTransform(springX, (v) => v * 0.5);
	const centralY = useTransform(springY, (v) => v * 0.5);
	const centralRotateX = useTransform(springY, (v) => v * -0.1);
	const centralRotateY = useTransform(springX, (v) => v * 0.1);
